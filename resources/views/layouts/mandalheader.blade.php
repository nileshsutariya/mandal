                    ...
                    <li class="nav-item dropdown profile-nav-item">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="menu-profile">
                                <span class="name">{{$mandal->mandal_name}}</span>
                                <img src="{{asset('imageuploaded/' . $user->image)}}" alt="Profile Image" class="rounded-circle">
                            </div>
                        </a>
                        ...
                        <a class="dropdown-item" href="{{ route('switchaccount', ['id' => $value->id]) }}">
                            ...
                            <img src="{{asset('imageuploaded/' . $user->image)}}"class="rounded-circle p-0" style="height: 25px; width: 25px;">
                            {{$user->name}}
                            </a>
