                ...
                <div class="card-body">
                    ...
                    <div class="profile-header mb-30">
                        <form action="{{ route('user.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <input type="file" id="imageInput" class="form-control form-control-file" name="image"
            ...
            <div class="row">
                ...
                <div class="col-md">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" data-type="adhaar-number" maxLength="14" 
                            name="adharcard" value="{{$user->adharcard_no}}">
                    </div>
                </div>
            </div>
